          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-300">09BSTPD0181R1ZO</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-300">+91 9336331985</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="container-custom py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
              ...
              <li className="flex items-center gap-2.5">
                ...
                <div className="flex flex-col">
                  <a href="tel:+919336373719" className="hover:text-white transition-colors">
                    Ashok Kumar Satsangi: +91 9336373719
                  </a>
                  <a href="tel:+919336331985" className="hover:text-white transition-colors">
                    Office / WhatsApp: +91 9336331985
                  </a>
                </div>
              </li>
              <li className="flex items-start gap-2.5">
            ...
            <div className="mt-5 text-[11px] text-slate-300 bg-white/5 rounded-xl p-3 border border-white/10">
              <span className="text-white font-bold block mb-0.5">GSTIN Registered</span>
              <span>09BSTPD0181R1ZO</span>
            </div>
          </div>
